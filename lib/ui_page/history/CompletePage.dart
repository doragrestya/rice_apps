...
//          ),
          Container(
            ...
            child: FutureBuilder(
                future: network.getOrder(myId,"4"),
                builder: (context, result) {
                  if (result.hasError) print(result.error);
                  return result.hasData
                      ? ListCompletePage(list: result.data)
                      : Center(
...
class ListCompletePage extends StatefulWidget {
  List list;
  ListCompletePage({this.list});
  @override
  _ListCompletePageState createState() => _ListCompletePageState();
}

class _ListCompletePageState extends State<ListCompletePage> {
  var dateFormate;
  BaseEndPoint network = NetworkProvider();
...
//                                context,
//                                MaterialPageRoute(
//                                    builder: (context) => DetailCompletePage(
...
class DetailCompletePage extends StatefulWidget {
  ...
  DetailCompletePage({this.kode, this.total, this.payment});
