...
class ProcessingPage extends StatefulWidget {
  ...
  ProcessingPage({this.controller});
  @override
...
//            ),
            Container(
              ...
              child: FutureBuilder(
                  future: network.getOrder(myId,"3"),
                  builder: (context, result) {
                    if (result.hasError) print(result.error);
                    return result.hasData
                        ? ListProcessPage(list: result.data)
                        : Center(
...
class ListProcessPage extends StatefulWidget {
  List list;
  ListProcessPage({this.list});
  @override
  _ListProcessPageState createState() => _ListProcessPageState();
}

class _ListProcessPageState extends State<ListProcessPage> {
  var dateFormate;
  BaseEndPoint network = NetworkProvider();
...
//                                context,
//                                MaterialPageRoute(
//                                    builder: (context) => DetailProcessPage(
...
class DetailProcessPage extends StatefulWidget {
  ...
  DetailProcessPage({this.kode, this.total, this.payment});
  @override
  _DetailProcessPageState createState() => _DetailProcessPageState();
}
