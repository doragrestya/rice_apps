      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="<?php echo site_url('admin/kategoris/add') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control-file <?php echo form_error('icon_kategori') 
                    ? 'is-invalid':'' ?>" 
                 type="file" name="icon_kategori"/>
                <div class="invalid-feedback">
