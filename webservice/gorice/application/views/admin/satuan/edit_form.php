          ...
          <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nama_satuan') ? 'is-invalid':'' ?>" type="text" name="nama_satuan", placeholder="Nama Satuan" value="<?php echo $satuan->nama_satuan?>"/>
