      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="<?php echo site_url('admin/keranjangs/add') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="detail_order">Detail Order*</label>
                <textarea class="form-control <?php echo form_error('detail_order') ? 'is-invalid':'' ?>" name="detail_order", placeholder="Detail Order"></textarea>
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('jumlah_produk') ? 'is-invalid':'' ?>" type="number",  name="jumlah_produk", placeholder="Jumlah Produk"></textarea>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('total_harga_produk') ? 'is-invalid':'' ?>" type="number", name="total_harga_produk", placeholder="Total Harga Produk"></textarea>
                <div class="invalid-feedback">
