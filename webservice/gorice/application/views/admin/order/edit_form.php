          ...
          <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('tanggal_order') ? 'is-invalid':'' ?>" name="tanggal_order", placeholder="Tanggal Order" value="<?php echo $order->tanggal_order ?>"/>
              ...
              <div class="form-group">
                <label for="name">Alamat User*</label>
                <textarea class="form-control <?php echo form_error('alamat_user') ? 'is-invalid':'' ?>" name="alamat_user", placeholder="Alamat User" ><?php echo $order->alamat_user ?></textarea>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('order_total') ? 'is-invalid':'' ?>" name="order_total", placeholder="Order Total" value="<?php echo $order->order_total ?>"/>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('id_checkout') ? 'is-invalid':'' ?>" name="id_checkout", placeholder="Id Checkout" value="<?php echo $order->id_checkout ?>"/>
                <div class="invalid-feedback">
