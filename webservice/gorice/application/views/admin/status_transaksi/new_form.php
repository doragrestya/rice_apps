      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="<?php echo site_url('admin/statuss/add') ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="status_transaksi">Status Transaksi*</label>
                <input class="form-control <?php echo form_error('status_transaksi') ? 'is-invalid':'' ?>" type="text" name="status_transaksi", placeholder="Status Transaksi"/>
