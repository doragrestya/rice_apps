          ...
          <div class="card-body">
            ...
            <form action="<?php echo site_url('admin/products/add') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('harga_produk') ? 'is-invalid':'' ?>" type="number" name="harga_produk", placeholder="Harga Produk"/>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('stok_produk') ? 'is-invalid':'' ?>" type="number" name="stok_produk", placeholder="Stok"/>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control-file <?php echo form_error('gambar_produk') 
                    ? 'is-invalid':'' ?>" 
              ...
              <div class="form-group">
                ...
                <textarea class="form-control <?php echo form_error('detail_produk') ? 'is-invalid':'' ?>" name="detail_produk", placeholder="Detail Produk..."></textarea>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('total_jual') ? 'is-invalid':'' ?>" type="number" name="total_jual", placeholder="Total Jual">
                <div class="invalid-feedback">
                ...
                <div class="form-line">
                  <select name="kategori" class="form-control" style="width: 300px">
                    ...
                    <?php foreach ($dd_kategori as $dd_kategori) : ?>
                      <option value="<?php echo $dd_kategori->id_kategori ?>">
                        <?php echo $dd_kategori->nama_kategori ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
